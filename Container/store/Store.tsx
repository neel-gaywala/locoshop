...
export function Store() {
  ...
  const searchedProductId = new URLSearchParams(router.query).get(
    "productId"
  );
  const searchedBrand = new URLSearchParams(router.query).get("brand");
  const searchedProductName = new URLSearchParams(router.query).get(
    "product"
  );
